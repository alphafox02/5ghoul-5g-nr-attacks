...
then
	...
	echo "./container.sh pull release-4g             - Pull $CONTAINER_NAME:release-4g to $CONTAINER_REPO:release-4g"
	echo "./container.sh pull release-5g             - Pull $CONTAINER_NAME:release-4g to $CONTAINER_REPO:release-5g"
